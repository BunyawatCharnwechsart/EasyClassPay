<template>
    <div class="navbar bg-[#FFC636] px-10 py-3 items-center justify-between select-none">
        <!-- โลโก้ -->
...
const {
    data : userData,
    error: userError
} = await useFetch('http://localhost:3005/api/users/getOneUser')

watch(userData, (newData) => {
    console.log('User data received:', newData)
})
</script>